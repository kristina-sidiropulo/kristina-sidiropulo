...
Я тестировщик. На данный момент работаю в компании Aviata.kz в команде backend разработки, где тестирую бекенд и частично фронтенд при помощи различных инструментов, таких как Postman, swagger и тд.
